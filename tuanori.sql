...
-- Thời gian đã tạo: Th1 21, 2023 lúc 02:11 PM
...
--
-- Cơ sở dữ liệu: `tcheckscamvietna_tuanori`
--
...
(1, '/img/cover.png', 'https://checkscamvietnam.info/', '/upload/favicon_3521.png', 'https://i.imgur.com/HYMox8C.png', 'checkscamvietnam.info', 'MMOVIP.ME | nơi tố các những kẻ lừa đảo đang lộng hành trên mạng xã hội', 'https://www.facebook.com/hphucgdtg', '0344447499');
...
CREATE TABLE `tmanh` (
  `id` int(11) NOT NULL,
  `code` varchar(9999) DEFAULT NULL,
  `anh` text,
  `title` text,
  `note` text,
