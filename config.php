<?php session_start(); ?>
<?php
define("DATABASE", "tcheckscamvietna_tuanori");//tên database
define("USERNAME", "tcheckscamvietna_tuanori");//tên tài khoản quản lí database
define("PASSWORD", "tcheckscamvietna_tuanori");//mật khẩu tài khoản
